...
if __name__ == '__main__':
    imgPath = '/content/drive/MyDrive/交大電子109上/深度學習_影像/Homework4/mixed'
    storePath = '/content/drive/MyDrive/交大電子109上/深度學習_影像/Homework4/RDN/train_x3_v4.h5'
    parser = argparse.ArgumentParser()
    parser.add_argument('--images-dir', type=str, required=True)
    parser.add_argument('--output-path', type=str, required=True)
    parser.add_argument('--scale', type=int, default=3)
    parser.add_argument('--eval', action='store_true')
    args = parser.parse_args(args=['--images-dir', imgPath, '--output-path', storePath, '--scale', '3'])
